...
public class Repository 
{
	...
	Robot robot;
	String Screen_filepath="C:\\Users\\karthik\\git\\karthik_project_48\\Karthik_project_48\\Screens\\";
	WebDriverWait wait;
	 ...
	 */
	public void Capture_Screen_At_Alert(Method method) throws Exception
	{
		...
		ImageIO.write(Bimage, "PNG", new File(Screen_filepath+method+".png"));
	}
